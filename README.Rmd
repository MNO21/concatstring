...
`concatstring` is a lightweight R package that provides a clean and extensible way to concatenate character vectors elementwise. It wraps results in a custom S3 class `concat_result`, allowing enhanced printing, summarisation, and visualisation.

---

## Installation

You can install the development version of `concatstring` from GitHub using [pak](https://pak.r-lib.org):
...
This package is intended as a teaching example and demonstration of S3 class systems, lightweight package structure, and clean testing with `{tinytest}`.
